...
namespace Uno.Native.Textures
{
    public class Texture : NativeObject
    {
        ...
        public TextureFileFormat FileFormat
        {
            get { return _info.FileFormat; }
        }
        ...
        public void ConvertCubeTo2D(TextureCube2DMode mode)
        {
        ...
        public void Compress(string dstFilename, PixelFormat format, bool generateMipMaps = true)
        {
            IOHelper.CreateContainingDirectory(dstFilename);
            CheckError(NativeLib.uTexture_Compress(Handle, dstFilename, format, generateMipMaps ? 1 : 0));
        }
    }
}
